...
async fn handle_event(ctx: &Context, payload_json: &str) {
    ...
    let dm_text = match status {
        ...
        "death" => format!(
            "🪦 Ton compagnon **{pet_name}** est mort... Ouvre ton salon depuis le panneau pour en adopter un nouveau."
        ),
