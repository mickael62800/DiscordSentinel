...
fn module_commands(bot_name: &str) -> Vec<CreateCommand> {
    match bot_name {
        ...
        "blackjack-bot" => modules::blackjack::register_commands(),
        "slot-bot" => modules::slot::register_commands(),
        "tamagotchi-bot" => modules::tamagotchi::register_commands(),
        "rotation-bot" => modules::rotation::register_commands(),
        "wheel-bot" => modules::wheel::register_commands(),
