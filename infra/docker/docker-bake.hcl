...
#   docker buildx bake -f infra/docker/docker-bake.hcl workers
#   docker buildx bake -f infra/docker/docker-bake.hcl api gateway bot
#
# Surcharger le tag :
#   TAG=v1.2.3 docker buildx bake -f infra/docker/docker-bake.hcl
# ============================================================================
...
target "_alpine-base" {
  context    = "."
  dockerfile = "infra/docker/Dockerfile.rust-alpine"
}

target "_debian-base" {
  context    = "."
  dockerfile = "infra/docker/Dockerfile.rust-debian"
}
...
target "api" {
  ...
  args = {
    ...
    MIGRATIONS_SRC = "services/api/migrations"
  }
...
target "bot" {
  ...
  args = {
    ...
    ASSETS_SRC = "bots/sentinel-bot/assets"
  }
