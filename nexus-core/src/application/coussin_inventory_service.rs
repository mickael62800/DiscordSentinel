...
use crate::{application::economy_config::load_coussin, domain::{entities::coussin_shop::item, errors::DomainError}, ports::{inbound::coussin_inventory::CoussinInventoryUseCase, outbound::{coussin_inventory_repository::{CoussinInventoryRepository, InventoryItem}, system::bot_config_repository::BotConfigRepository}}};
pub struct CoussinInventoryService { repo: Arc<dyn CoussinInventoryRepository>, config_repo: Arc<dyn BotConfigRepository> }
impl CoussinInventoryService { pub fn new(repo: Arc<dyn CoussinInventoryRepository>, config_repo: Arc<dyn BotConfigRepository>) -> Self { Self { repo, config_repo } } }
#[async_trait]
