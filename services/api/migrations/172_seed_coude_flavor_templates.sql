...
-- hardcodees dans :
--   - bots/sentinel-bot/.../voler.rs   (steal_success_afk/fight, steal_fail)
--   - bots/sentinel-bot/.../braquage.rs (heist_success, heist_fail)
--   - bots/sentinel-bot/.../prank.rs    (prank_scoop, prank_appel)
--
