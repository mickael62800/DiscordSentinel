...
impl CoudeCombatRepository for MockCombatRepo {
    ...
    async fn claim_expired_pending_combats(&self, _: i64) -> Result<Vec<CoudeCombat>, DomainError> {
...
fn make_combat(guild: &str, defender: &str, mise: i64) -> CoudeCombat {
    CoudeCombat {
        id: Uuid::new_v4(),
        guild_id: guild.into(),
