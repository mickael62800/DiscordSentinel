...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        // Blackjack
        .route("/api/blackjack/start", post(handlers::casino::blackjack::start_game))
        .route("/api/blackjack/{game_id}/hit", post(handlers::casino::blackjack::hit))
        .route("/api/blackjack/{game_id}/stand", post(handlers::casino::blackjack::stand))
        .route("/api/blackjack/{game_id}/double", post(handlers::casino::blackjack::double_down))
        .route("/api/blackjack/{guild_id}/{user_id}/active", get(handlers::casino::blackjack::get_active))
        // Phase 8 — administration blackjack (prefixe "admin" pour eviter
        // collision avec les routes dynamiques /api/blackjack/{game_id}/*).
        .route("/api/blackjack/admin/{guild_id}/games", get(handlers::casino::blackjack::list_games))
        .route("/api/blackjack/admin/games/{game_id}", delete(handlers::casino::blackjack::cancel_game))
        .route("/api/blackjack/admin/{guild_id}/purge", delete(handlers::casino::blackjack::purge_all))
        // Blackjack tables (multijoueur)
        .route("/api/blackjack/tables", post(handlers::casino::blackjack::create_table))
        .route("/api/blackjack/tables/{table_id}/join", post(handlers::casino::blackjack::join_table))
        .route("/api/blackjack/tables/{table_id}/players", get(handlers::casino::blackjack::list_table_players))
        .route("/api/blackjack/tables/{table_id}/games", get(handlers::casino::blackjack::list_table_games))
        .route("/api/blackjack/tables/{table_id}", delete(handlers::casino::blackjack::close_table))
        .route("/api/blackjack/tables/by-channel/{channel_id}", get(handlers::casino::blackjack::get_table_by_channel))
        .route("/api/blackjack/admin/{guild_id}/tables", get(handlers::casino::blackjack::list_tables_by_guild))
