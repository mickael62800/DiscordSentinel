...
pub fn routes() -> Router<AppState> {
    Router::new()
        // Audit logs
        .route("/api/audit-logs", get(handlers::audit::audit_logs::list_audit_logs).post(handlers::audit::audit_logs::create_audit_log))
        .route("/api/audit-logs/{guild_id}", delete(handlers::audit::audit_logs::purge_audit_logs))
        // Watched users
