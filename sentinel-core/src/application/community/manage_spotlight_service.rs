...
use crate::domain::entities::community::spotlight::{
    is_valid_period, period_of, Spotlight, UpsertSpotlightCommand,
};
use crate::domain::errors::DomainError;
use crate::ports::inbound::community::manage_spotlight::ManageSpotlightUseCase;
use crate::ports::outbound::community::spotlight_repository::SpotlightRepository;
