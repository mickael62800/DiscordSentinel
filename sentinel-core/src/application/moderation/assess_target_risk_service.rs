...
use crate::domain::entities::moderation::target_risk::{
    decide_target_risk, TargetRiskDecision, TargetRiskFacts,
};
use crate::domain::errors::DomainError;
use crate::ports::inbound::moderation::assess_target_risk::{
...
impl AssessTargetRiskUseCase for AssessTargetRiskService {
    async fn assess(
        ...
        crate::application::validation::validate_guild_id(&cmd.guild_id)?;
