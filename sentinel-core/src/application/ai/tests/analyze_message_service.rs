...
impl BotConfigRepository for MockBotConfigRepo {
    async fn get_definitions(
        ...
        Vec<crate::domain::entities::system::bot_config::BotDefinition>,
    ...
    async fn get_config(
        ...
        Vec<crate::domain::entities::system::bot_config::BotGuildConfig>,
        crate::domain::errors::DomainError,
    > {
        Ok(vec![])
    }
...
impl RuleRepository for MockRuleRepo {
    async fn find_by_guild(
        &self,
        _: &str,
    ) -> Result<Vec<crate::domain::entities::system::rule::Rule>, crate::domain::errors::DomainError>
    {
        Ok(vec![])
    }
    async fn find_all(
    ...
    async fn find_by_id(
        ...
        Option<crate::domain::entities::system::rule::Rule>,
        crate::domain::errors::DomainError,
    > {
        Ok(None)
    }
    async fn save(
        &self,
        rule: &crate::domain::entities::system::rule::Rule,
    ) -> Result<crate::domain::entities::system::rule::Rule, crate::domain::errors::DomainError>
    {
        Ok(rule.clone())
    }
    async fn toggle(
...
impl InfractionRepository for MockInfractionRepo {
    ...
    async fn find_by_guild(
        &self,
        _: &str,
        _: &crate::ports::inbound::moderation::manage_infractions::InfractionFilters,
    ) -> Result<
        Vec<crate::domain::entities::moderation::infraction::Infraction>,
        crate::domain::errors::DomainError,
    > {
        Ok(vec![])
    }
    ...
    async fn count_today(&self) -> Result<u64, crate::domain::errors::DomainError> {
        Ok(0)
    }
    async fn find_by_id(
        &self,
        ...
        Option<crate::domain::entities::moderation::infraction::Infraction>,
        crate::domain::errors::DomainError,
    > {
        Ok(None)
    }
    async fn delete_by_id(&self, _: &str) -> Result<bool, crate::domain::errors::DomainError> {
        Ok(false)
    }
...
impl CachePort for MockCache {
    async fn get_rules(
        ...
        Option<Vec<crate::domain::entities::system::rule::Rule>>,
        crate::domain::errors::DomainError,
    > {
        Ok(None)
    }
    ...
    async fn invalidate_rules(&self, _: &str) -> Result<(), crate::domain::errors::DomainError> {
        Ok(())
    }
    async fn get_json(
        &self,
        _: &str,
    ) -> Result<Option<String>, crate::domain::errors::DomainError> {
        Ok(None)
    }
    async fn set_json(
        &self,
    ...
    async fn invalidate(&self, _: &str) -> Result<(), crate::domain::errors::DomainError> {
        Ok(())
    }
    async fn invalidate_pattern(&self, _: &str) -> Result<(), crate::domain::errors::DomainError> {
        Ok(())
    }
}
