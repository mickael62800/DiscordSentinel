...
use crate::domain::entities::ai::ai_job::{AiJob, NewAiJob};
use crate::domain::entities::system::job_whitelists::is_valid_ai_job_type;
use crate::domain::errors::DomainError;
use crate::ports::inbound::ai::manage_ai_jobs::ManageAiJobsUseCase;
use crate::ports::outbound::ai::ai_job_repository::AiJobRepository;
