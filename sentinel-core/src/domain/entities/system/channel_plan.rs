...
use crate::domain::entities::system::channel_access::{validate_access, ChannelAccess};
use crate::domain::errors::DomainError;
use crate::domain::services::system::discord_naming::slugify_channel_name;
...
pub struct PlannedChannel {
    ...
    /// [`crate::domain::entities::system::channel_access`].
    #[serde(default)]
...
mod tests {
    use super::*;
    use crate::domain::entities::system::channel_access::AccessMode;
