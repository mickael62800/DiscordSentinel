...
#
# Exemples :
#   ./sentinel-infrastructure/scripts/tls-issue.sh --letsencrypt --domain bot.exemple.com --email toi@exemple.com
#   ./sentinel-infrastructure/scripts/tls-issue.sh --staging     --domain bot.exemple.com --email toi@exemple.com
#   ./sentinel-infrastructure/scripts/tls-issue.sh --self-signed --domain localhost
# ============================================
