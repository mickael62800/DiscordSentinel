...
#
# Usage :
#   sudo bash sentinel-infrastructure/scripts/setup-host-security.sh fail2ban
#   sudo bash sentinel-infrastructure/scripts/setup-host-security.sh all
#
# Modules :
...
# .php, etc. — cf. sentinel-web/nginx.conf "Anti-scanner"). Les requetes 444
...
setup_nginx_scanner() {
    ...
    #    dans nginx:1.27-alpine (cf. sentinel-web/Dockerfile).
