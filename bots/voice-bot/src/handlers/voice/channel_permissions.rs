//! Gestion des permissions Discord sur le panel membres associé à un salon vocal.
...
use crate::handler::{MembersToVoiceMapKey, VoiceOwnerMapKey};

/// Donne à un nouveau participant l'accès au salon texte "panel membres"
/// associé à `voice_channel_id`.
...
/// Retire l'accès au panel membres pour un membre qui quitte le vocal.
///
/// Ne retire pas l'accès au propriétaire (il garde le panel ouvert même quand
