...
use self::api_client::{Action, AnalyzeRequest, ApiClient, MessageMetadata};
use self::detectors::DetectorConfig;
...
// ══════════════════════════════════════════════════════════════════════
// Review mode: card + button handler
// ══════════════════════════════════════════════════════════════════════
    ...
    let context_messages = if context_max_messages == 0 {
            ...
            .await
        {
            Ok(messages) => messages
                ...
                .map(|m| self::api_client::ContextMessage {
