...
impl Default for AuditConfig {
    fn default() -> Self {
        Self {
            message_cache_size: sentinel_shared::config::load_env("MESSAGE_CACHE_SIZE", 10_000),
            anomaly_window_secs: sentinel_shared::config::load_env("ANOMALY_WINDOW_SECS", 60),
            anomaly_mass_ban_threshold: sentinel_shared::config::load_env("ANOMALY_MASS_BAN", 5),
            anomaly_mass_delete_threshold: sentinel_shared::config::load_env("ANOMALY_MASS_DELETE", 20),
            anomaly_mass_role_threshold: sentinel_shared::config::load_env("ANOMALY_MASS_ROLE", 10),
        }
    }
}
