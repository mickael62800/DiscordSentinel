//! MOD #3 — Commande `/review` : file de relecture des actions de moderation.
//!
//! Sous-commandes :
//!   - `/review add <action_id> [reason]` — ajoute une action a la queue
//!   - `/review list` — liste les reviews pending
//!   - `/review resolve <review_id> <status> [notes]` — resout une review
//!
//! Statuts accepts pour resolve : `approved`, `rejected`, `changed`.
