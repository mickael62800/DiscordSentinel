...
//!
//! Avant Phase 6A, ce sweep etait fait localement via un `sleep(60s)` loop
//! qui lisait le `ChannelManager` (DashMap in-memory). Le refactor debloque
//! le scaling horizontal de blackjack-bot.
