  ...
  <div class="tab-content">
    ...
    <section class="card">
      ...
      <div v-if="trivyError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh trivy</code></p>
      </div>
      <div v-else-if="trivy">
    ...
    <section class="card">
      ...
      <div v-if="integrityError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh file-integrity</code></p>
      </div>
