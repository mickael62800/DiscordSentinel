  ...
  <div class="tab-content">
    ...
    <section class="card">
      ...
      <div v-if="sshError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh ssh-failures</code></p>
      </div>
    ...
    <section class="card">
      ...
      <div v-if="suspiciousError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh nginx-suspicious</code></p>
      </div>
