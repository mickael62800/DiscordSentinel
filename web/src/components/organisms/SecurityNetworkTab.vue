  ...
  <div class="tab-content">
    ...
    <section class="card">
      ...
      <div v-if="connectionsError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh connections</code></p>
      </div>
    ...
    <section class="card">
      ...
      <div v-if="portsError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh open-ports</code></p>
      </div>
    ...
    <section class="card">
      ...
      <div v-if="outboundError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh outbound</code></p>
      </div>
    ...
    <section class="card">
      ...
      <div v-if="tlsErrorsError" class="info-banner">
        ...
        <p class="hint small">Setup : <code>sudo bash infrastructure/scripts/setup-host-security.sh tls-errors</code></p>
      </div>
