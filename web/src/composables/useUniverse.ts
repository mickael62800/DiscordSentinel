...
export function useUniverse() {
  ...
  /// Nexus n'est propose que si l'utilisateur y a droit. Quelqu'un qui n'a
  /// que Sentinel ne voit meme pas que l'autre univers existe.
  const canAccessNexus = computed(() => visible("nexus.config"));
