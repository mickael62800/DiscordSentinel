...
const backbone = ref<"camembert-base" | "camembert/camembert-large">("camembert-base");
        ...
        <section class="model-info">
          <template v-if="activeTab === 'text-sentiment'">
            ...
            <p>
              ...
              les messages a sanctionner (rage, menaces) vs le reste (safe).
            </p>
        ...
        <section class="section-card">
          ...
          <div class="params-grid">
            <div v-if="activeTab === 'text-sentiment'" class="param">
              ...
              <select v-model="backbone" :disabled="status.running">
                ...
                <option value="camembert/camembert-large">camembert-large (~1,3 Go, +2-3% accuracy)</option>
              </select>
            </div>
            <div class="param">
              <label>Epochs</label>
          ...
          <div class="toggle-row">
            <label class="toggle">
              ...
              <small>Compense le desequilibre safe/severe (79/21)</small>
            </label>
            <label class="toggle">
