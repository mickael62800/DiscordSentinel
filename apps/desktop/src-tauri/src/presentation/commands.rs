...
tauri_passthrough!(edit_discord_role, DiscordRolesService, edit_role -> serde_json::Value, guild_id: String, role_id: String, name: Option<String>, color: Option<u32>, permissions: Option<String>, mentionable: Option<bool>, hoist: Option<bool>);
...
#[tauri::command]
pub async fn ai_get_datasets(
    adapter: tauri::State<'_, std::sync::Arc<crate::infrastructure::api_adapter::ApiAdapter>>,
...
#[tauri::command]
pub async fn ai_training_status(
    adapter: tauri::State<'_, std::sync::Arc<crate::infrastructure::api_adapter::ApiAdapter>>,
) -> Result<serde_json::Value, String> {
    let base = ai_base_url(&adapter);
    let resp = reqwest::Client::new()
