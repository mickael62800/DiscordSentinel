...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            presentation::commands::create_discord_role,
            presentation::commands::edit_discord_role,
            presentation::commands::delete_discord_role,
            ...
            presentation::commands::rbac_list_guild_users,
            presentation::commands::rbac_get_my_role,
