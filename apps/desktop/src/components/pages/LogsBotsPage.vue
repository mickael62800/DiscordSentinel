...
const { filteredLogs, sources, loading, filterLevel, filterBot, dateFrom, dateTo, search, clearLogs } = useLogs("bot");

async function handleClear() {
  if (!confirm("Supprimer tous les journaux bots ?")) return;
  await clearLogs();
}
...
<template>
  <div class="logs">
    ...
    <DataTable
      ...
      empty-message="Aucun journal bot"
    >
