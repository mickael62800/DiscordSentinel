  ...
  switch (wsEvent.event) {
    case "infraction_new":
      return {
        ...
        title: `New ${data.action ?? "infraction"}`,
        message: `${data.username ?? "User"} — ${data.reason ?? "No reason"}`,
    ...
    case "ticket_new":
      return {
        ...
        title: "New ticket",
        message: `${data.author_name ?? "User"}: ${data.title ?? ""}`,
    ...
    case "ticket_message":
      return {
        ...
        notification_type: "ticket",
        title: "Ticket reply",
        message: `${data.author_name ?? "User"} replied to ticket`,
        severity: "low",
        read: false,
        created_at: now,
      };
    ...
    case "bot_status": {
      ...
      return {
        ...
        message: `${data.bot ?? "Bot"} is now ${online ? "connected" : "disconnected"}`,
    ...
    case "raid_detected":
      return {
        ...
        title: "Raid detected",
        message: data.message ?? "Suspicious join activity detected",
        severity: "critical",
        read: false,
        created_at: now,
      };
    ...
    case "security_event":
      return {
        ...
        message: data.description ?? "Security event detected",
    ...
    case "moderation_action":
      return {
        ...
        title: `${data.action_type ?? "Action"} applied`,
        message: `${data.moderator_name ?? "Moderator"} → ${data.target_name ?? "user"}: ${data.reason ?? ""}`,
