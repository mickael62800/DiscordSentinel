...
<template>
  <router-link :to="path" :class="['nav-item', { active }]">
    <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <template v-else-if="icon === 'user-x'">
      ...
      <template v-else-if="icon === 'ticket'">
      ...
      <template v-else-if="icon === 'clipboard'">
      ...
      <template v-else-if="icon === 'brain'">
        <path d="M12 2a6 6 0 00-4.24 10.24A4 4 0 006 16v1a2 2 0 002 2h8a2 2 0 002-2v-1a4 4 0 00-1.76-3.76A6 6 0 0012 2z" />
        <path d="M10 22v-2" /><path d="M14 22v-2" />
        <path d="M9 9h0" /><path d="M15 9h0" />
        <path d="M12 6v6" /><path d="M9 12h6" />
      </template>
      ...
      <template v-else-if="icon === 'dollar-sign'">
        <line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" />
      </template>
      <template v-else-if="icon === 'wallet'">
        <path d="M20 12V8H6a2 2 0 01-2-2c0-1.1.9-2 2-2h12v4" /><path d="M4 6v12c0 1.1.9 2 2 2h14v-4" /><path d="M18 12a2 2 0 000 4h4v-4z" />
      </template>
      <template v-else-if="icon === 'edit-3'">
        <path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" />
      </template>
      <template v-else-if="icon === 'clock'">
        <circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />
      </template>
      <template v-else-if="icon === 'paperclip'">
        <path d="M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48" />
      </template>
      <template v-else-if="icon === 'check-circle'">
        <path d="M22 11.08V12a10 10 0 11-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" />
      </template>
      <template v-else-if="icon === 'bar-chart-2'">
        <line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" />
      </template>
      <template v-else-if="icon === 'user-plus'">
        <path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="8.5" cy="7" r="4" /><line x1="20" y1="8" x2="20" y2="14" /><line x1="23" y1="11" x2="17" y2="11" />
      </template>
      <template v-else-if="icon === 'sliders'">
        <line x1="4" y1="21" x2="4" y2="14" /><line x1="4" y1="10" x2="4" y2="3" /><line x1="12" y1="21" x2="12" y2="12" /><line x1="12" y1="8" x2="12" y2="3" /><line x1="20" y1="21" x2="20" y2="16" /><line x1="20" y1="12" x2="20" y2="3" /><line x1="1" y1="14" x2="7" y2="14" /><line x1="9" y1="8" x2="15" y2="8" /><line x1="17" y1="16" x2="23" y2="16" />
      </template>
      <template v-else-if="icon === 'user-check'">
        <path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="8.5" cy="7" r="4" /><polyline points="17 11 19 13 23 9" />
      </template>
      <template v-else-if="icon === 'refresh-cw'">
