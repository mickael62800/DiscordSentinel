...
struct VoiceChannelRow {
    ...
    channel_name: String,
    kind: crate::adapters::outbound::postgres::types::PgVoiceChannelKind,
    visibility: String,
    queue_enabled: bool,
    locked: bool,
    stage_enabled: bool,
...
impl From<VoiceChannelRow> for VoiceChannel {
    fn from(row: VoiceChannelRow) -> Self {
        Self {
            ...
            text_channel_id: row.text_channel_id.into(),
            members_channel_id: row.members_channel_id.into(),
            queue_channel_id: row.queue_channel_id.into(),
...
impl VoiceChannelStore for super::PgVoiceChannelRepository {
    ...
    async fn save(&self, channel: &VoiceChannel) -> Result<(), DomainError> {
        ...
        .bind(crate::adapters::outbound::postgres::types::PgVoiceChannelKind::from(channel.kind))
