...
impl ReviewRepository for PgReviewRepository {
    ...
    async fn list_pending(&self, guild_id: &str) -> Result<Vec<ReviewEntry>, sentinel_core::domain::errors::DomainError> {
        #[derive(sqlx::FromRow)]
        struct Row {
    ...
    async fn get_guild_id(&self, review_id: uuid::Uuid) -> Result<Option<String>, sentinel_core::domain::errors::DomainError> {
