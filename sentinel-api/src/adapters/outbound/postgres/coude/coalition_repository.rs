...
use sentinel_core::domain::entities::coude::coalition::CoalitionMember;
use sentinel_core::domain::entities::coude::coalition::CoalitionStatus;
use sentinel_core::domain::entities::coude::coalition::COALITION_MIN_MEMBERS;
