...
use sentinel_proto::confessions::v1::confessions_service_server::ConfessionsService;
use tonic::Request;
use tonic::Response;
use tonic::Status;

use crate::adapters::inbound::grpc::errors::domain_to_status;
use sentinel_core::domain::entities::community::confession::Confession;
use sentinel_core::domain::entities::community::confession::ConfessionConfig;
use sentinel_core::domain::entities::community::confession::ConfessionReply;
use sentinel_core::ports::inbound::community::manage_confessions::CreateConfessionCommand;
use sentinel_core::ports::inbound::community::manage_confessions::CreateReplyCommand;
use sentinel_core::ports::inbound::community::manage_confessions::CreateReportCommand;
