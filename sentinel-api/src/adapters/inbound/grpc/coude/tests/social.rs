...
impl ManageCoudeCashboxUseCase for MockCashboxUc {
    ...
    async fn list_redistributions(&self, _: &str, _: i64) -> Result<Vec<sentinel_core::domain::entities::coude::cashbox::CashboxRedistribution>, DomainError> {
        unimplemented!()
    }
    async fn list_entries(&self, _: Uuid) -> Result<Vec<sentinel_core::domain::entities::coude::cashbox::CashboxRedistributionEntry>, DomainError> {
        unimplemented!()
    }
}
