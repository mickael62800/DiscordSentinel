...
fn proto_source_to_domain_all_variants() {
    ...
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceShopPurchase as i32
        ),
        Some(CashboxSource::ShopPurchase)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceInsurancePurchase as i32
        ),
        Some(CashboxSource::InsurancePurchase)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceProtectionPurchase as i32
        ),
        Some(CashboxSource::ProtectionPurchase)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceBoostPurchase as i32
        ),
        Some(CashboxSource::BoostPurchase)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceClassChangeCost as i32
        ),
        Some(CashboxSource::ClassChangeCost)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceResetStatsCost as i32
        ),
        Some(CashboxSource::ResetStatsCost)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceDonationTax as i32
        ),
        Some(CashboxSource::DonationTax)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceCowardicePenalty as i32
        ),
        Some(CashboxSource::CowardicePenalty)
    );
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceBetCommission as i32
        ),
...
fn proto_steal_duration_to_domain_all_variants() {
    ...
    assert_eq!(
        inventory::proto_steal_duration_to_domain(
            proto::StealProtectionDurationKind::StealProtectionDurationOneDay as i32
        ),
        Some(D::OneDay)
    );
    assert_eq!(
        inventory::proto_steal_duration_to_domain(
            proto::StealProtectionDurationKind::StealProtectionDurationThreeDays as i32
        ),
        Some(D::ThreeDays)
    );
    assert_eq!(
        inventory::proto_steal_duration_to_domain(
            proto::StealProtectionDurationKind::StealProtectionDurationFiveDays as i32
        ),
        Some(D::FiveDays)
    );
    assert_eq!(
        inventory::proto_steal_duration_to_domain(
            proto::StealProtectionDurationKind::StealProtectionDurationSevenDays as i32
        ),
        Some(D::SevenDays)
    );
    assert_eq!(
        inventory::proto_steal_duration_to_domain(
            proto::StealProtectionDurationKind::StealProtectionDurationUnspecified as i32
        ),
        None
    );
...
fn proto_source_to_domain_unspecified_and_invalid() {
    assert_eq!(
        social::proto_source_to_domain(
            proto::CashboxDepositSource::CashboxSourceUnspecified as i32
        ),
        None
    );
