...
fn influence_inner() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/{guild_id}/orgs/treasury/dividend",
            post(handlers::influence::orgs::treasury_dividend),
        )
        .route(
            "/{guild_id}/orgs/fund-law",
            post(handlers::influence::orgs::fund_law),
        )
        .route(
            "/{guild_id}/motions",
        ...
        .route(
            "/{guild_id}/orgs/channel/link",
            post(handlers::influence::orgs::link_channel),
        )
        .route(
            "/{guild_id}/archives",
