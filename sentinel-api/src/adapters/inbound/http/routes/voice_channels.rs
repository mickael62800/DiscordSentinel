...
fn voice_inner() -> Router<AppState> {
    Router::new()
        .route("/_all", get(handlers::community::voice_channels::list_all_channels))
        .route("/{guild_id}", get(handlers::community::voice_channels::list_channels))
        .route(
            "/{guild_id}/history",
            get(handlers::community::voice_channels::list_history_channels)
                .delete(handlers::community::voice_channels::purge_history),
        )
        .route("/", post(handlers::community::voice_channels::create_channel))
        .route(
        ...
        .route("/by-channel/{channel_id}/close", patch(handlers::community::voice_channels::close_channel))
        .route("/by-channel/{channel_id}/events", get(handlers::community::voice_channels::list_channel_events))
        .route("/by-channel/{channel_id}/purge", delete(handlers::community::voice_channels::purge_channel))
        .route("/by-channel/{channel_id}/transfer", patch(handlers::community::voice_channels::transfer_ownership))
        .route("/by-channel/{channel_id}/co-admins", post(handlers::community::voice_channels::add_co_admin))
        .route("/by-channel/{channel_id}/co-admins/{user_id}", delete(handlers::community::voice_channels::remove_co_admin))
        ...
        .route("/by-channel/{channel_id}/invites/{link_id}", delete(handlers::community::voice_channels::revoke_invite_link))
        .route("/invites/{code}/use", post(handlers::community::voice_channels::use_invite_link))
        // Themes
        .route("/themes/{guild_id}", get(handlers::community::voice_channels::list_themes).post(handlers::community::voice_channels::create_theme))
        .route("/themes/{guild_id}/{theme_id}", patch(handlers::community::voice_channels::update_theme).delete(handlers::community::voice_channels::delete_theme))
}
