...
use sentinel_core::domain::entities::coude::prestige::PRESTIGE_MAX_COUNT;
...
pub async fn prestige_player(
    ...
    let unlock_level = settings.get_i32(
        ...
        sentinel_core::domain::entities::coude::prestige::PRESTIGE_UNLOCK_LEVEL,
    );
    ...
    Ok(Json(PrestigeOutcomeDto {
        ...
        stars: sentinel_core::domain::entities::coude::prestige::prestige_stars(new_count),
    }))
}
