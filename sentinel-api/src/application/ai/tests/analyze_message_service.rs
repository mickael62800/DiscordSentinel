...
impl BotConfigRepository for MockBotConfigRepo {
    async fn get_definitions(&self) -> Result<Vec<sentinel_core::domain::entities::system::bot_config::BotDefinition>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn get_config(&self, _: &str, _: &str) -> Result<Vec<sentinel_core::domain::entities::system::bot_config::BotGuildConfig>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn get_all_config(&self, _: &str) -> Result<Vec<sentinel_core::domain::entities::system::bot_config::BotGuildConfig>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn set_config(&self, _: &str, _: &str, _: &str, _: &str) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn delete_config(&self, _: &str, _: &str, _: &str) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
}
...
impl RuleRepository for MockRuleRepo {
    async fn find_by_guild(&self, _: &str) -> Result<Vec<sentinel_core::domain::entities::system::rule::Rule>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn find_all(&self) -> Result<Vec<sentinel_core::domain::entities::system::rule::Rule>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn find_by_id(&self, _: uuid::Uuid) -> Result<Option<sentinel_core::domain::entities::system::rule::Rule>, sentinel_core::domain::errors::DomainError> { Ok(None) }
    async fn save(&self, rule: &sentinel_core::domain::entities::system::rule::Rule) -> Result<sentinel_core::domain::entities::system::rule::Rule, sentinel_core::domain::errors::DomainError> { Ok(rule.clone()) }
    async fn toggle(&self, _: uuid::Uuid, _: bool) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn delete(&self, _: uuid::Uuid) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
}
...
impl InfractionRepository for MockInfractionRepo {
    async fn save(&self, _: &sentinel_core::domain::entities::moderation::infraction::Infraction) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn find_by_guild(&self, _: &str, _: &crate::ports::inbound::moderation::manage_infractions::InfractionFilters) -> Result<Vec<sentinel_core::domain::entities::moderation::infraction::Infraction>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn find_all(&self, _: i64, _: i64) -> Result<Vec<sentinel_core::domain::entities::moderation::infraction::Infraction>, sentinel_core::domain::errors::DomainError> { Ok(vec![]) }
    async fn count_today(&self) -> Result<u64, sentinel_core::domain::errors::DomainError> { Ok(0) }
    async fn find_by_id(&self, _: &str) -> Result<Option<sentinel_core::domain::entities::moderation::infraction::Infraction>, sentinel_core::domain::errors::DomainError> { Ok(None) }
    async fn delete_by_id(&self, _: &str) -> Result<bool, sentinel_core::domain::errors::DomainError> { Ok(false) }
    async fn delete_older_than_days(&self, _: &str, _: i32) -> Result<u64, sentinel_core::domain::errors::DomainError> { Ok(0) }
}
...
impl CachePort for MockCache {
    async fn get_rules(&self, _: &str) -> Result<Option<Vec<sentinel_core::domain::entities::system::rule::Rule>>, sentinel_core::domain::errors::DomainError> { Ok(None) }
    async fn set_rules(&self, _: &str, _: &[sentinel_core::domain::entities::system::rule::Rule]) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn invalidate_rules(&self, _: &str) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn get_json(&self, _: &str) -> Result<Option<String>, sentinel_core::domain::errors::DomainError> { Ok(None) }
    async fn set_json(&self, _: &str, _: &str, _: u64) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn invalidate(&self, _: &str) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
    async fn invalidate_pattern(&self, _: &str) -> Result<(), sentinel_core::domain::errors::DomainError> { Ok(()) }
}
...
impl ManageConductUseCase for MockConduct {
    async fn get_config(&self, _: &str) -> Result<sentinel_core::domain::entities::community::conduct::ConductConfig, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn save_config(&self, _: crate::ports::inbound::community::manage_conduct::SaveConductConfigCommand) -> Result<sentinel_core::domain::entities::community::conduct::ConductConfig, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn get_points(&self, _: &str, _: &str) -> Result<sentinel_core::domain::entities::community::conduct::UserConductPoints, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn get_leaderboard(&self, _: &str, _: i64) -> Result<Vec<sentinel_core::domain::entities::community::conduct::UserConductPoints>, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn get_points_log(&self, _: &str, _: &str, _: i64) -> Result<Vec<sentinel_core::domain::entities::community::conduct::ConductPointsLog>, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn deduct_points(&self, _: DeductPointsCommand) -> Result<sentinel_core::domain::entities::community::conduct::UserConductPoints, sentinel_core::domain::errors::DomainError> {
        let now = chrono::Utc::now();
        Ok(sentinel_core::domain::entities::community::conduct::UserConductPoints { id: uuid::Uuid::new_v4(), guild_id: String::new(), user_id: String::new(), username: String::new(), points: 100, last_regen_at: now, created_at: now, updated_at: now })
    }
    async fn add_points(&self, _: crate::ports::inbound::community::manage_conduct::AddPointsCommand) -> Result<sentinel_core::domain::entities::community::conduct::UserConductPoints, sentinel_core::domain::errors::DomainError> { unimplemented!() }
    async fn run_regen(&self) -> Result<u64, sentinel_core::domain::errors::DomainError> { Ok(0) }
}
    ...
    use sentinel_core::domain::services::moderation::channel_tension::TensionAction;
    ...
    fn bot_entry(key: &str, value: &str) -> sentinel_core::domain::entities::system::bot_config::BotGuildConfig {
        sentinel_core::domain::entities::system::bot_config::BotGuildConfig {
            id: uuid::Uuid::new_v4(),
