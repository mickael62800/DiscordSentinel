...
use sentinel_core::domain::entities::coude::steal::protection::find_protection_item;
...
use sentinel_core::domain::entities::coude::steal::protection::STEAL_PROTECTION_ITEMS;
