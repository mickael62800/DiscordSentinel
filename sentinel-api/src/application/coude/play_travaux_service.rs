...
use sentinel_core::domain::entities::coude::travaux::fail_flavor_at;
use sentinel_core::domain::entities::coude::travaux::success_flavor_at;
use sentinel_core::domain::entities::coude::travaux::task_at;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_COINS_MAX;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_COINS_MIN;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_COOLDOWN_KEY;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_COOLDOWN_SECS;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_FAIL_FLAVORS;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_SUCCESS_FLAVORS;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_SUCCESS_PCT;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_TASKS;
use sentinel_core::domain::entities::coude::travaux::TRAVAUX_XP_PER_TASK;
