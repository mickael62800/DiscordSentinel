...
use sentinel_core::domain::entities::coude::combat::resolution_rules::apply_insurance_to_loss;
use sentinel_core::domain::entities::coude::combat::resolution_rules::compute_combat_xp;
use sentinel_core::domain::entities::coude::combat::outcome_flags::detect_outcome_flags;
use sentinel_core::domain::entities::coude::combat::resolution_rules::format_bet_payout_lines;
use sentinel_core::domain::entities::coude::combat::outcome_flags::CombatOutcomeFlags;
use sentinel_core::domain::entities::coude::combat::outcome_flags::COMEBACK_HP_PCT_MAX;
use sentinel_core::domain::errors::DomainError;
use sentinel_core::domain::services::coude::coude_combat_engine as engine;
use sentinel_core::domain::services::coude::coude_combat_engine::PlayerLite;
use sentinel_core::domain::services::coude::coude_combat_engine::ServerEventLite;
...
impl ResolveCombatNowUseCase for ResolveCombatNowService {
    async fn resolve_now(
        ...
        let mythic_event: Option<sentinel_core::domain::entities::coude::mythic_events::MythicEvent> = {
            use sentinel_core::domain::entities::coude::mythic_events::roll_mythic_event;
        ...
        let (season_chaos_multiplier, season_tank_def_bonus) = {
            use sentinel_core::domain::entities::coude::season_theme::season_chaos_multiplier as season_chaos;
            use sentinel_core::domain::entities::coude::season_theme::season_tank_def_bonus_pct as season_tank;
        ...
        self.combat_repo
            .resolve(
                combat.id,
                sentinel_core::domain::entities::coude::combat::CombatResolution {
        ...
        let mut bets_draw_taunts: Vec<sentinel_core::domain::entities::coude::taunt::TauntEvent> = Vec::new();
        ...
        match (&result.winner_id, &result.loser_id) {
            (Some(winner_id), Some(loser_id)) => {
                ...
                use sentinel_core::domain::entities::coude::vendetta::apply_revenge_bonus;
                ...
                let coins_transferred = if let Some(coalition_repo) = &self.coalition_repo {
                    use sentinel_core::domain::entities::coude::coalition::apply_coalition_penalty;
                    use sentinel_core::domain::entities::coude::coalition::COALITION_GAIN_MULTIPLIER;
                ...
                let coins_transferred = if let Some(prepo) = &self.player_repo {
                    use sentinel_core::domain::entities::coude::prestige::prestige_gain_multiplier_with_params;
                ...
                if let Some(curses_repo) = &self.curses_repo {
                    use sentinel_core::domain::entities::coude::curse::poison_redirect_amount;
                    use sentinel_core::domain::entities::coude::curse::CurseKind;
                ...
                if let (Some(curses_repo), Some(_ins)) = (&self.curses_repo, &active_insurance) {
                    use sentinel_core::domain::entities::coude::curse::CurseKind;
                    use sentinel_core::domain::entities::coude::curse::FAUSSE_ASSURANCE_FEE_COINS;
                    if let Ok(Some(c)) = curses_repo
                ...
                let actual_loss = if shield_enabled {
                    sentinel_core::domain::entities::coude::lucky_shield::apply_lucky_shield_with_multiplier(
                ...
                let actual_loss = if has_safety_net {
                    use sentinel_core::domain::entities::coude::safety_net::reduce_loss_with_multiplier as safety_net_reduce_loss_with_multiplier;
        ...
        match (&result.winner_id, &result.loser_id) {
            (Some(winner_id), Some(loser_id)) => {
                ...
                use sentinel_core::domain::entities::coude::bounty::BOUNTY_AUTO_OPEN_STREAK_THRESHOLD;
                use sentinel_core::domain::entities::coude::bounty::BOUNTY_INITIAL_AMOUNT;
                        ...
                        .await
                    {
                        ...
                        if winner_streak >= BOUNTY_AUTO_OPEN_STREAK_THRESHOLD {
                                ...
                                .await
                            {
                                ...
                                taunt_events.push(sentinel_core::domain::entities::coude::taunt::TauntEvent {
        ...
        let mythic_announce: Option<String> = mythic_event.map(|ev| {
            use sentinel_core::domain::entities::coude::mythic_events::format_mythic_announce;
        ...
        {
            use sentinel_core::domain::entities::coude::fake_spectators::format_spectator_chat;
            use sentinel_core::domain::entities::coude::fake_spectators::pick_spectator_chat;
            use rand::rngs::StdRng;
            use rand::SeedableRng;
...
fn compute_outcome_flags_from_result(
    result: &sentinel_core::domain::services::coude::coude_combat_engine::combat::CombatResult,
    combat: &sentinel_core::domain::entities::coude::combat::Combat,
) -> CombatOutcomeFlags {
...
use sentinel_core::domain::entities::coude::player::title_for_level as title_for_level;
