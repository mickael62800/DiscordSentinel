...
use sentinel_core::domain::entities::coude::combat::validation::check_min_hp_pct;
use sentinel_core::domain::entities::coude::combat::validation::check_surprise_hp_pct;
use sentinel_core::domain::entities::coude::combat::validation::validate_new_combat;
