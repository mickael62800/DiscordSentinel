...
use sentinel_core::domain::entities::coude::economy::clamp_steal_amount;
use sentinel_core::domain::entities::coude::economy::clamp_steal_fail_penalty;
use sentinel_core::domain::entities::coude::curse::CurseKind;
use sentinel_core::domain::entities::coude::taunt::TauntEvent;
use sentinel_core::domain::entities::coude::curse::LEAKY_WALLET_FEE_COINS;
...
impl ManageCoudeEconomyService {
    ...
    async fn season_steal_bonus(&self, guild_id: &str, thief_id: &str, stolen: i64) -> i64 {
        ...
        sentinel_core::domain::entities::coude::season_theme::compute_season_steal_bonus(player.season, stolen)
    }
}
