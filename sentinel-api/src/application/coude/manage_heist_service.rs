...
use sentinel_core::domain::entities::coude::heist::compute_success_chance;
use sentinel_core::domain::entities::coude::balance::BalanceParams;
use sentinel_core::domain::entities::coude::heist::HeistOutcome;
use sentinel_core::domain::entities::coude::heist::HEIST_GAIN_MAX_PERCENT;
use sentinel_core::domain::entities::coude::heist::HEIST_GAIN_MIN_PERCENT;
use sentinel_core::domain::entities::coude::heist::HEIST_TOOLS;
...
impl ManageCoudeHeistService {
    ...
    async fn effective_cooldown_days(
        ...
        sentinel_core::domain::entities::coude::season_theme::apply_season_braquage_cooldown(player.season, base_cooldown_days)
    }
