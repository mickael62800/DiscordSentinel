...
use sentinel_core::domain::entities::coude::steal::roll::STEAL_D20_MAX;
use sentinel_core::domain::entities::coude::steal::roll::STEAL_D20_MIN;
use sentinel_core::domain::entities::coude::steal::STEAL_PCT_ACTIVE_MAX_BP;
use sentinel_core::domain::entities::coude::steal::STEAL_PCT_ACTIVE_MIN_BP;
use sentinel_core::domain::entities::coude::steal::STEAL_PCT_AFK_MAX_BP;
use sentinel_core::domain::entities::coude::steal::STEAL_PCT_AFK_MIN_BP;
