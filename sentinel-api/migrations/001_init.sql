...
-- puis seeds (alert_rules, bot_definitions, game_templates).
--
...
--
-- Name: game_audit_log; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_backups; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_backups (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: game_panels; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_panels (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    guild_id text NOT NULL,
    channel_id text NOT NULL,
    message_id text NOT NULL,
...
--
-- Name: game_player_sessions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_server_configs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_servers; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_session_registrations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_session_registrations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    server_id uuid NOT NULL,
    user_id text NOT NULL,
...
--
-- Name: game_template_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_template_settings (
    guild_id text NOT NULL,
...
--
-- Name: COLUMN game_templates.init_files; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.game_templates.init_files IS 'Fichiers a uploader dans le container avant start. Format : [{"path": "/abs/path", "content": "templatable {{KEY}}"}]. Les {{KEY}} sont remplaces par les env vars (defaults + overrides) au moment du start.';


--
-- Name: COLUMN game_templates.command_template; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.game_templates.command_template IS 'Command Docker (JSON array string : [\"bin\", \"arg1\", \"arg2\"]). Override le CMD de l''image. Templatable via {{KEY}}. NULL = laisse l''image decider.';
...
--
-- Name: game_audit_log game_audit_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_audit_log
    ADD CONSTRAINT game_audit_log_pkey PRIMARY KEY (id);


--
-- Name: game_backups game_backups_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_backups
    ADD CONSTRAINT game_backups_pkey PRIMARY KEY (id);


--
-- Name: game_panels game_panels_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_panels
    ADD CONSTRAINT game_panels_pkey PRIMARY KEY (id);


--
-- Name: game_player_sessions game_player_sessions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_player_sessions
    ADD CONSTRAINT game_player_sessions_pkey PRIMARY KEY (id);


--
-- Name: game_server_configs game_server_configs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_server_configs
    ADD CONSTRAINT game_server_configs_pkey PRIMARY KEY (server_id, config_key);


--
-- Name: game_servers game_servers_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_session_registrations game_session_registrations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_session_registrations game_session_registrations_server_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_session_registrations
    ADD CONSTRAINT game_session_registrations_server_id_user_id_key UNIQUE (server_id, user_id);


--
-- Name: game_template_settings game_template_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_template_settings
    ADD CONSTRAINT game_template_settings_pkey PRIMARY KEY (guild_id, template_slug);
...
--
-- Name: idx_game_audit_log_guild; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_audit_log_guild ON public.game_audit_log USING btree (guild_id, created_at DESC);


--
-- Name: idx_game_audit_log_server; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_audit_log_server ON public.game_audit_log USING btree (server_id, created_at DESC);


--
-- Name: idx_game_backups_server; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_backups_server ON public.game_backups USING btree (server_id, created_at DESC);


--
-- Name: idx_game_panels_guild_cat; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_game_panels_guild_cat ON public.game_panels USING btree (guild_id, COALESCE(category, ''::text));


--
-- Name: idx_game_panels_message; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_panels_message ON public.game_panels USING btree (guild_id, message_id);


--
-- Name: idx_game_player_sessions_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_player_sessions_active ON public.game_player_sessions USING btree (server_id, player_name) WHERE (left_at IS NULL);


--
-- Name: idx_game_player_sessions_server; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_player_sessions_server ON public.game_player_sessions USING btree (server_id, joined_at DESC);


--
-- Name: idx_game_servers_guild; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_servers_guild ON public.game_servers USING btree (guild_id) WHERE (deleted_at IS NULL);


--
-- Name: idx_game_servers_ip_reveal; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_servers_ip_reveal ON public.game_servers USING btree (ip_reveal_at) WHERE ((ip_revealed = false) AND (ip_reveal_at IS NOT NULL) AND (deleted_at IS NULL));


--
-- Name: idx_game_servers_last_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_servers_last_active ON public.game_servers USING btree (last_active_at) WHERE ((deleted_at IS NULL) AND ((status)::text = 'running'::text));


--
-- Name: idx_game_servers_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_servers_status ON public.game_servers USING btree (status) WHERE (deleted_at IS NULL);


--
-- Name: idx_game_session_reg_server; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_game_session_reg_server ON public.game_session_registrations USING btree (server_id);
...
CREATE INDEX idx_game_templates_slug ON public.game_templates USING btree (slug) WHERE (deleted_at IS NULL);


--
-- Name: idx_games_guild; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_games_guild ON public.games USING btree (guild_id);


--
-- Name: idx_games_guild_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_games_guild_name ON public.games USING btree (guild_id, lower(game_name));


--
-- Name: idx_games_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_games_role_id ON public.games USING btree (guild_id, role_id) WHERE (role_id IS NOT NULL);
...
--
-- Name: uq_game_servers_container_name; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_game_servers_container_name ON public.game_servers USING btree (container_name) WHERE ((container_name IS NOT NULL) AND (deleted_at IS NULL));


--
-- Name: uq_game_servers_host_port; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_game_servers_host_port ON public.game_servers USING btree (host_port) WHERE ((host_port IS NOT NULL) AND (deleted_at IS NULL));


--
-- Name: uq_game_servers_rcon_port; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX uq_game_servers_rcon_port ON public.game_servers USING btree (rcon_port) WHERE ((rcon_port IS NOT NULL) AND (deleted_at IS NULL));
...
--
-- Name: game_audit_log game_audit_log_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_audit_log
    ADD CONSTRAINT game_audit_log_server_id_fkey FOREIGN KEY (server_id) REFERENCES public.game_servers(id) ON DELETE SET NULL;


--
-- Name: game_backups game_backups_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_backups
    ADD CONSTRAINT game_backups_server_id_fkey FOREIGN KEY (server_id) REFERENCES public.game_servers(id) ON DELETE CASCADE;


--
-- Name: game_player_sessions game_player_sessions_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_player_sessions
    ADD CONSTRAINT game_player_sessions_server_id_fkey FOREIGN KEY (server_id) REFERENCES public.game_servers(id) ON DELETE CASCADE;


--
-- Name: game_server_configs game_server_configs_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_server_configs
    ADD CONSTRAINT game_server_configs_server_id_fkey FOREIGN KEY (server_id) REFERENCES public.game_servers(id) ON DELETE CASCADE;


--
-- Name: game_servers game_servers_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_servers
    ADD CONSTRAINT game_servers_template_id_fkey FOREIGN KEY (template_id) REFERENCES public.game_templates(id);


--
-- Name: game_session_registrations game_session_registrations_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.game_session_registrations
    ADD CONSTRAINT game_session_registrations_server_id_fkey FOREIGN KEY (server_id) REFERENCES public.game_servers(id) ON DELETE CASCADE;
